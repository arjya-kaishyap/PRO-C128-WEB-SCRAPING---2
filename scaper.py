    ...
    for i  in range(1,5):
         while True:
            ...
            if current_page_num<i :
                ...
                browser.find_element(By.XPATH, value = '//*[@id="mw-content-text"]/div[1]/table[7]/thead').click()
            else:
                break    
            for ul_tag in soup.find_all("ul",attrs = {"class","stars"}):
                th_tags = ul_tag.find_all("tr")
                temp_list = []
            ...
            WebDriverWait(browser,20).until(EC.element_to_be_clickable((By.XPATH,'//*[@id="mw-content-text"]/div[1]/table[8]/thead'))).click()
